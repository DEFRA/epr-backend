...
const TEST_FILE_PATH = path.resolve(__dirname, '../fixtures/reprocessor.xlsx')

/**
 * @typedef {Object} ContractTestFixtures
 * @property {import('./port.js').UploadsRepository} uploadsRepository - The adapter under test
