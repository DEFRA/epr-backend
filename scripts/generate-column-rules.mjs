...
const TOOL_PATH = 'scripts/generate-column-rules.mjs'
const TOOL_REPO = 'DEFRA/epr-backend'
const TOOL_URL = `https://github.com/${TOOL_REPO}/blob/main/${TOOL_PATH}`

const header = [
  `<!-- GENERATED FILE - DO NOT EDIT BY HAND. Generated by ${TOOL_REPO} ${TOOL_PATH}. To update, re-run the tool and replace this file with its output. -->`,
  '',
  '# Summary Log Column Rules',
  '',
  'A per-column reference of every rule applied to a Summary Log, for all five templates.',
  '',
  `> ⚠️ **Generated file - do not edit by hand.** This page is produced by the column-rules generator, [\`${TOOL_PATH}\`](${TOOL_URL}) in the \`${TOOL_REPO}\` repository, which introspects the live table schemas.`,
  '>',
  `> To update it, run \`node ${TOOL_PATH}\` from an \`epr-backend\` checkout and replace this file with the output. Any manual edits will be lost the next time it is generated. Because it is derived from the code, it cannot drift from what actually validates uploads.`,
  '',
