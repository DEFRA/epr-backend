...
export const RECEIVED_LOADS_FIELDS = Object.freeze({
  ...
  LOADING_SITE_ADDRESS: 'LOADING_SITE_ADDRESS',
  LOADING_SITE_POSTCODE: 'LOADING_SITE_POSTCODE',
  LOADING_SITE_EMAIL: 'LOADING_SITE_EMAIL',
  LOADING_SITE_PHONE_NUMBER: 'LOADING_SITE_PHONE_NUMBER',
  CARRIER_NAME: 'CARRIER_NAME',
  CBD: 'CBD',
  CARRIER_VEHICLE_REGISTRATION_NUMBER: 'CARRIER_VEHICLE_REGISTRATION_NUMBER',
  OSR_NAME: 'OSR_NAME',
  OSR_COUNTRY: 'OSR_COUNTRY',
  TONNAGE_RECEIVED_BY_OSR: 'TONNAGE_RECEIVED_BY_OSR',
  BILL_OF_LANDING_REFERENCE_NUMBER: 'BILL_OF_LANDING_REFERENCE_NUMBER',
