...
import { MESSAGES, PATTERNS, CONSTANTS } from './joi-messages.js'
...
describe('joi-messages', () => {
  describe('MESSAGES', () => {
    it('exports message constants', () => {
      ...
      expect(MESSAGES.MUST_BE_AT_LEAST_10000).toBe('must be at least 10000')
    })
  ...
  describe('CONSTANTS', () => {
    it('exports MIN_ROW_ID', () => {
      expect(CONSTANTS.MIN_ROW_ID).toBe(10000)
    })
