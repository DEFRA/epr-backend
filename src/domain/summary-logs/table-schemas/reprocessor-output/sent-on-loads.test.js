...
describe('SENT_ON_LOADS (REPROCESSOR_OUTPUT)', () => {
  ...
  describe('structure', () => {
    ...
    it('has no classifyForWasteBalance (reprocessor-output sent-on loads do not contribute to waste balance)', () => {
      expect(schema.classifyForWasteBalance).toBeUndefined()
    })
