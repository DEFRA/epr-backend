...
const baseConfig = {
  ...
  featureFlags: {
    ...
    exporterReportDataValidation: {
      doc: 'Feature Flag: Block exporter report creation when mandatory summary-log row data is incomplete (PAE-1420)',
      format: Boolean,
      default: false,
      env: 'FEATURE_FLAG_EXPORTER_REPORT_DATA_VALIDATION'
    }
  },
