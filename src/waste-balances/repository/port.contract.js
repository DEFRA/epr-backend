...
import { testAppendRegisteredOnlySubmittedEventBehaviour } from './contract/appendRegisteredOnlySubmittedEvent.contract.js'
...
export const testWasteBalancesRepositoryContract = (repositoryFactory) => {
  ...
  testAppendRegisteredOnlySubmittedEventBehaviour(repositoryFactory)
}
