 ...
 * general `creditTotal` uses. Reprocessor-output rows and rows whose table does
 * not contribute return zero before any date is read.
 *
 ...
 * The December portion therefore stays consistent with the total by
 * construction: excluded rows contribute zero, sent-on rows deduct, and a
 * resubmission's delta self-corrects.
 *
