...
import { RECEIVED_LOADS_FIELDS } from '#domain/summary-logs/table-schemas/exporter-registered-only/fields.js'
import { PROCESSING_TYPES } from '#domain/summary-logs/meta-fields.js'
import { toYearMonth } from '#common/helpers/dates/year-month.js'

const rowIdField = RECEIVED_LOADS_FIELDS.ROW_ID
const monthField = RECEIVED_LOADS_FIELDS.MONTH_RECEIVED_FOR_EXPORT
 ...
 */
export const transformReceivedLoadsExportRowRegisteredOnly = (
  rowData,
  rowIndex
) => {
