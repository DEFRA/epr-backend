...
/**
 * Transforms a row from RECEIVED_LOADS_FOR_REPROCESSING table into waste record metadata (Reprocessor Output)
 *
 ...
 */
export const transformReceivedLoadsRowReprocessorOutput = (
  rowData,
  rowIndex
) => {
