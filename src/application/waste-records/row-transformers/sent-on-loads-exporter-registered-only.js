...
import { SENT_ON_LOADS_FIELDS } from '#domain/summary-logs/table-schemas/exporter-registered-only/fields.js'
 ...
 */
export const transformSentOnLoadsRowExporterRegisteredOnly = (
  rowData,
  rowIndex
) => {
