...
import { SENT_ON_LOADS_FIELDS } from '#domain/summary-logs/table-schemas/reprocessor-registered-only/fields.js'
 ...
 */
export const transformSentOnLoadsRowRegisteredOnly = (rowData, rowIndex) => {
