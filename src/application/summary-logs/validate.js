...
/**
 * The accreditation the ledger stream is partitioned on — the summary log's own
 * when present, otherwise the registration's — so a read pivots on the same
 * stream the submit path appended to.
 *
 ...
 * }} params
 * @returns {Promise<Map<string, WasteRecordState>>}
 */
