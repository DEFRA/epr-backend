...
/**
 * Fatal-level schema fields for RECEIVED_LOADS_FOR_REPROCESSING table
 *
 ...
 */
const RECEIVED_LOADS_FOR_REPROCESSING_FATAL_FIELDS = {
...
/**
 * Row-level schema fields for RECEIVED_LOADS_FOR_REPROCESSING table
 *
 * These validations produce ERROR severity issues that mark specific rows
 * as invalid but don't block submission of the entire spreadsheet.
 */
const RECEIVED_LOADS_FOR_REPROCESSING_ROW_FIELDS = {
 ...
 */
export const RECEIVED_LOADS_FOR_REPROCESSING_FATAL_SCHEMA = Joi.object(
 ...
 *
 * Validates all fields except ROW_ID (which is validated by the fatal schema).
 * Failures produce ERROR severity issues that mark specific rows as invalid
 * but don't block submission of the entire spreadsheet.
 *
