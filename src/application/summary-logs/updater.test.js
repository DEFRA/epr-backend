...
describe('SummaryLogUpdater', () => {
  ...
  it('should clear failure reason when transitioning to validated', async () => {
    const summaryLogWithFailure = {
      ...summaryLog,
    ...
    await summaryLogUpdater.update({
      id: 'summary-log-123',
      version: 2,
      summaryLog: summaryLogWithFailure,
      status: SUMMARY_LOG_STATUS.VALIDATED
    })
  ...
  it('should not clear failure reason when transitioning to other statuses', async () => {
    const summaryLogWithFailure = {
      ...summaryLog,
      failureReason: 'Previous error'
    }
