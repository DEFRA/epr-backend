...
/**
 * Throws a 400 Boom enriched with CDP-indexed `code` and `event` fields.
 *
...
/**
 * Throws a 409 Boom enriched with CDP-indexed `code` and `event` fields.
 *
 * @param {string} message
 * @param {string} code
 * @param {BoomEnrichment} enrichment
...
/**
 * Throws a 500 Boom enriched with CDP-indexed `code` and `event` fields.
 *
 * @param {string} message
 * @param {string} code
 * @param {BoomEnrichment} enrichment
