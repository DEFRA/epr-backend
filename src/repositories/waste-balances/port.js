 ...
 * @property {(wasteRecords: import('#domain/waste-records/model.js').WasteRecord[], accreditationId: string, options: { user?: Object, overseasSites: Record<number, { validFrom: Date | null }> | symbol }) => Promise<void>} updateWasteBalanceTransactions
