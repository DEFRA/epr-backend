 ...
 * @property {(wasteRecords: import('#domain/waste-records/model.js').WasteRecord[], accreditationId: string, user?: Object, overseasSites?: Record<number, { validFrom: Date | null }>) => Promise<void>} updateWasteBalanceTransactions
