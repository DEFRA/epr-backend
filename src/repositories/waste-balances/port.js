 ...
 * @property {(wasteRecords: import('#domain/waste-records/model.js').WasteRecord[], accreditationId: string, user: import('#common/helpers/auth/types.js').CommandUser) => Promise<void>} updateWasteBalanceTransactions
