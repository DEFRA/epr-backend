 ...
 * @property {(id: string, version: number, target: StatusTransitionTarget, toStatus: string, updatedBy: string) => Promise<Organisation>} appendStatusHistory - Append a status transition to the target item under whole-org version CAS; returns the updated organisation. Throws Boom.conflict (409) on version mismatch.
 */
