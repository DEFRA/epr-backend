...
const testBasicUpdate = (getRepository) => {
...
const testUpdateNonExistent = (getRepository) => {
...
const testFieldPreservation = (getRepository) => {
...
export const testUpdateBehaviour = (getRepository) => {
  describe('update', () => {
    testBasicUpdate(getRepository)
    testUpdateNonExistent(getRepository)
    testFieldPreservation(getRepository)
  })
}

const testIdParameterValidation = (getRepository) => {
...
const testUpdatesParameterValidation = (getRepository) => {
  describe('updates parameter validation', () => {
    ...
    it('rejects update with empty file object', async () => {
      ...
      await expect(getRepository().update(id, 1, { file: {} })).rejects.toThrow(
        /file/
      )
    })
...
export const testUpdateValidation = (getRepository) => {
  describe('update validation', () => {
    testIdParameterValidation(getRepository)
    testUpdatesParameterValidation(getRepository)
  })
}
