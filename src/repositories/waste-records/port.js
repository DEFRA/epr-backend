 ...
 * @property {(organisationId: string, registrationId: string, wasteRecordVersions: Map<WasteRecordType, Map<string, VersionData>>, accreditationId?: string) => Promise<void>} appendVersions
 */
