...
export const testFindByRegistrationBehaviour = (it) => {
  describe('findByRegistration', () => {
    ...
    it('returns all waste records for specific organisation and registration', async () => {
    ...
    it('does not return waste records from different organisations', async () => {
    ...
    it('does not return waste records from different registrations', async () => {
