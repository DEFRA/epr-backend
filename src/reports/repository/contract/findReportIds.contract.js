...
export const testFindPeriodicReportsBehaviour = (it) => {
  describe('findPeriodicReports', () => {
    ...
    it(`includes slots from multiple periods in a single document (${MONTHLY_PERIOD_LABELS[1]} and ${MONTHLY_PERIOD_LABELS[2]})`, async () => {
    ...
    it(`reflects previous report ids after re-creation for same slot (${MONTHLY_PERIOD_LABELS[1]})`, async () => {
