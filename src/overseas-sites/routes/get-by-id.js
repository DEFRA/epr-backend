...
export const overseasSiteById = {
  ...
  handler: async (request, h) => {
    ...
    try {
      ...
      logger.info({
        message: `Overseas site retrieved: id=${id}`,
        event: {
      ...
      logger.error({
        err: error,
        message: `Failure on ${overseasSiteByIdPath}`,
        event: {
          category: LOGGING_EVENT_CATEGORIES.SERVER,
      ...
      throw Boom.badImplementation(`Failure on ${overseasSiteByIdPath}`)
    }
  }
}
